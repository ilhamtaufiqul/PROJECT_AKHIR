<div class="jumbotron jumbotron-fluid">
    <div class="container" style="padding-top: 1cm">
        ...
        <h3 class=" text-muted text-center" style="padding-left: 1.2cm">Guide</h3>
        <hr>

        <div class="card-group">
            @foreach ($mountain as $data)
            {{-- <div class=" col-md-3">
                    <div class=" card" style="width: 12.63rem;">
                        <a href="{{ route('list.guide', $data->mountain_seo) }}">
            <img src="{{ asset('images/'. $data->foto) }}" class=" card-img-top" style="width: 200px; height: 150px">
            <div class=" card-body">
                <h6 class="card-tittle">{{ $data->nama_gunung }}</h6>({{ $data->photos->count() }} Guide)
            </div>
            </a>
        </div>
    </div> --}}
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group mx-auto">
                            <a href="{{ route('list.guide', $data->mountain_seo) }}" type="button" class="btn btn-sm btn-outline-success" style="width: 3cm">View Guide</a>
                        </div>
                    </div>
                </div>
